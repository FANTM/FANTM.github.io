...
For connecting the DEVLPR to a software project (e.g. connecting it to a game), see [devlprd-py](https://docs.getfantm.com/devlpr/software/devlprd-py).
...
The whole library is open-source and can be found [here](https://github.com/FANTM/libdevlpr).
...
*void* **setFlexCallback**(*void (\*f)(Devlpr \*d), float threshMult=1.5, unsigned int millisCooldown=400*)
